...
@Table(name = "ingredientreceivenote_has_ingredient") //for map with employeestatus table db
...
public class IRNHasIngredient {
    ...
    @ManyToOne
    @JoinColumn(name = "ingredientreceivenote_id", referencedColumnName = "id")
