...
@RequestMapping(value = "/suppaymethod") // class level mapping. meka use karama mapping name value eka liyadhi /user eken patanganna oneh nah.
public class SupPaymentMethodController {
	...
	private SupPaymentMethodDao dao;
	...
	public List<SupPaymentMethod> getallData() {
